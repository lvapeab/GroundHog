...
class CostLayer(Layer):
    ...
    def __init__(self, rng,
        ...
        :type optimize_probs: bool
        :param optimize_probs: flag, if true, optimizes the softmax layer get
            cost function by avoiding advanced indexing, this optimization is
            to speed-up training but results in a larger memory consumption
        ...
        self.optimize_probs = optimize_probs
        self._init_params()
