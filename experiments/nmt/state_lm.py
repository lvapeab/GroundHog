...
def prototype_lm_state_en_wiki_30kzh():
    state = prototype_lm_state()
    state['target']='/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/binarized_wiki.en.h5'

    state['indx_word'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/ivocab.en.pkl'
    state['word_indx'] = '/data/lisatmp3/firatorh/nmt/en_lm/en-wiki-only/vocab.en.pkl'
    state['cutoff'] = 2.2
    ...
    state['prefix']='/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/test_val_'

    return state

def prototype_lm_state_en_wiki_30kzh_valid():
    state = prototype_lm_state()
    state['reload'] = False
    # This relates to joint lm/tm training
    state['reload_lm'] = False
    ...
    state['target'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/binarized_wiki.en.shuf.h5'
    state['val_target'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/binarized_text.dev2010.zh-en.en.h5'
    state['indx_word'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/ivocab.en.pkl'
    state['word_indx'] = '/data/lisatmp3/firatorh/nmt/en_lm/en-wiki-only/vocab.en.pkl'

    state['cutoff'] = 5.0
    state['cost_threshold'] = 1.0003
    state['divide_lr'] = 1.0
    state['moment'] = 0.98
    ...
    state['prefix']='/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/test_val_rmsprop_'

    return state

def prototype_lm_state_en_wiki_30kzh_adadelta():
    state = prototype_lm_state()
    state['reload'] = False
    ...
    state['target'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/binarized_wiki.en.shuf2.h5'
    state['val_target'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/binarized_text.dev2010.zh-en.en2.h5'
    state['indx_word'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/ivocab.en.pkl'
    state['word_indx'] = '/data/lisatmp3/firatorh/nmt/en_lm/en-wiki-only/vocab.en.pkl'
    ...
    state['prefix']='/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/test_val_adadelta_'

    return state

def prototype_lm_state_en_wiki_30kzh_adadelta_bigram():
    state = prototype_lm_state()
    state['reload'] = False
    state['check_first_word'] = True
    state['bigram'] = True
    ...
    state['target'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/binarized_text.dev2010.zh-en.en2.h5'
    state['val_target'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/binarized_text.dev2010.zh-en.en3.h5'
    state['indx_word'] = '/data/lisatmp3/gulcehrc/nmt/en_lm/en-wiki-only/ivocab.en.pkl'
    state['word_indx'] = '/data/lisatmp3/firatorh/nmt/en_lm/en-wiki-only/vocab.en.pkl'
