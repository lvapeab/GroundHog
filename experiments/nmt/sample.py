...
class BeamSearch(object):
    ...
    def __init__(self, enc_dec):
        ...
        self.eos_id = enc_dec.state['null_sym_target']
        self.unk_id = enc_dec.state['unk_sym_target']
        ...
        for k in range(3 * len(seq)):
            ...
            if self.enc_dec.state['include_lm']:
                if self.enc_dec.state['use_arctic_lm']:
                    ...
                    log_probs = numpy.log(self.comp_next_probs(c, k, last_words, states_lm,
                        *states)[0])
            else:
...
def parse_args():
    ...
    parser.add_argument("--n-best", default=1,
            type=int, help="n-best list")
    ...
    if args.source and args.trans:
        ...
        for i, line in enumerate(fsrc):
            ...
            for j, best in enumerate(nbest_idx):
                ...
                if args.scores:
                    print >>fidx_scores, "%d|||%d|||%f" % (i, j, costs[best])
